...
function EducationDetailsComponent(props) {
  ...
  return (
    <Grid container component="main" className={classes.root}>
      ...
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        <LoaderOverlay
          active={data.loading}
          text="Loading Eduactional Information..."
        >
          <div className={classes.paper}>
            ...
            <Typography align="center">
              Select your education qualification and upload the document.
            </Typography>
